...
describe('LoginRequest', () => {
  ...
  describe('postLoginUrl()', () => {
    it('should return the user account uri if no redirect_uri param', () => {
      const request = new LoginRequest({ authQueryParams: {}, accountManager })

      const aliceAccount = 'https://alice.localhost:8443'
      const user = { username: 'alice', accountUri: aliceAccount }
