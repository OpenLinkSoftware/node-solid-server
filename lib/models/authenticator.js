...
class TlsAuthenticator extends Authenticator {
   ...
   *
   * @return {Promise<webId:string>} WebID data
   */
  ...
  verifyWebId (certificate, auth_callback) {
    ...
    if (!delegator)
      webid.verify(certificate, auth_callback);
    else
