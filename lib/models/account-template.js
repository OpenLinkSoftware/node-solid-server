...
class AccountTemplate {
   ...
   */
  static for (userAccount, options = {}, accountManager = {}) {
    let substitutions = AccountTemplate.templateSubstitutionsFor(userAccount, accountManager)
   ...
   * @return {Object}
   */
  static templateSubstitutionsFor (userAccount, accountManager) {
    let addOwlSameAs = userAccount.externalWebId &&
           userAccount.tlsCertificateWebid &&
           userAccount.externalWebId !== userAccount.tlsCertificateWebid

    let substitutions = {
      name: userAccount.displayName,
      webId: userAccount.webId,
      extWebId: userAccount.externalWebId,
      email: userAccount.email,

      tlsCertWebid: userAccount.tlsCertificateWebid,
      tlsCertModulus: userAccount.tlsCertificateModulus,
      tlsCertExponent: userAccount.tlsCertificateExponent,
      addOwlSameAs,
      AuthOIDC: accountManager.authMethod === 'oidc',
