...
class AccountTemplate {
  ...
  static for (userAccount, options = {}, accountManager = {}) {
    const substitutions = AccountTemplate.templateSubstitutionsFor(userAccount, accountManager)
  ...
  static templateSubstitutionsFor (userAccount, accountManager) {
    let addOwlSameAs = userAccount.externalWebId && userAccount.externalWebId !== userAccount.webId
    ...
    const substitutions = {
      ...
      accountUri: accountManager.accountUriFor(userAccount.username),
