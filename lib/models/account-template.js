...
class AccountTemplate {
  ...
  static templateSubstitutionsFor (userAccount) {
    let substitutions = {
      ...
      tls_cert_webid: userAccount.tls_certificate_webid,
      tls_cert_modulus: userAccount.tls_certificate_modulus,
      tls_cert_exponent: userAccount.tls_certificate_exponent
    }
